...
#ifndef POLA_KEYED_VECTOR_H_
#define POLA_KEYED_VECTOR_H_

#include <assert.h>
#include <stdint.h>
#include <sys/types.h>

#include "pola/utils/SortedVector.h"
...
const VALUE& KeyedVector<KEY,VALUE>::valueFor(const KEY& key) const {
    ...
    LOG_FATAL_IF((i < 0), "%s: key not found", __PRETTY_FUNCTION__);
